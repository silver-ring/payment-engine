...
@Component
public class CreatedVoucherActivationBulkOrderItemWriteListener {

  private final CvaboCreatedVoucherRepo createdVoucherRepo;

  @Autowired
  public CreatedVoucherActivationBulkOrderItemWriteListener(CvaboCreatedVoucherRepo createdVoucherRepo) {
