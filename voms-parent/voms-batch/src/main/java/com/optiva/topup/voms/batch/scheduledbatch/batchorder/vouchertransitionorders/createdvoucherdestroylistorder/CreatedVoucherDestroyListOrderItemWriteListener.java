...
@Component
public class CreatedVoucherDestroyListOrderItemWriteListener {

  private final CvdloCreatedVoucherRepo createdVoucherRepo;

  @Autowired
  public CreatedVoucherDestroyListOrderItemWriteListener(CvdloCreatedVoucherRepo createdVoucherRepo) {
