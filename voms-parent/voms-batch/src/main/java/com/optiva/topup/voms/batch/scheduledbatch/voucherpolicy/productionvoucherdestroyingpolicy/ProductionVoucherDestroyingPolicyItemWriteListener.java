...
@Component
public class ProductionVoucherDestroyingPolicyItemWriteListener {

  private final PvdpProductionVoucherRepo productionVoucherRepo;

  @Autowired
  public ProductionVoucherDestroyingPolicyItemWriteListener(
      PvdpProductionVoucherRepo productionVoucherRepo) {
  ...
  public void afterWrite(List<? extends DestroyedVoucher> destroyedVouchers) {
    ...
    productionVoucherRepo.deleteBySerialNumberIn(serialNumbers);
  }
