...
@Component
public class PendingUsageVoucherUsingListOrderItemWriteListener {

  private final PuvuloPendingUsageVoucherRepo pendingUsageVoucherRepo;

  @Autowired
  public PendingUsageVoucherUsingListOrderItemWriteListener(
      PuvuloPendingUsageVoucherRepo pendingUsageVoucherRepo) {
    this.pendingUsageVoucherRepo = pendingUsageVoucherRepo;
  }

  @AfterWrite
  public void afterWrite(List<? extends UsedVoucher> usedVouchers) {
    List<Long> serialNumbers = usedVouchers.stream()
