...
class EditCreatedVoucherModificationListOrder extends React.Component {
          ...
          <Grid item xs={12}>
            <OptionalControl defaultValue={modifyRechargeValue != null}
              ...
              <SingleValueSelect required
                                 ...
                                 property={"name"} field="rechargeValue"
...
export default EditCreatedVoucherModificationListOrder;
