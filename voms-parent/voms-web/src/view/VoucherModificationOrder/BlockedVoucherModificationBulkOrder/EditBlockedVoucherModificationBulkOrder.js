...
class EditBlockedVoucherModificationBulkOrder extends React.Component {
        ...
        <EditBulkOrderForm data={data}>
          ...
          <Grid item xs={12}>
            <OptionalControl defaultValue={modifyVoucherType != null}
              ...
              <SingleValueSelect required label={"Voucher Type"}
          ...
          <Grid item xs={12}>
            <OptionalControl defaultValue={modifyRechargeValue != null}
              ...
              <SingleValueSelect required label={"Recharge Value"}
...
export default EditBlockedVoucherModificationBulkOrder;
