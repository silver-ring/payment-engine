...
class UserEmailDomainMigrationHistory extends React.Component {

  state = {
    userEmailDomainMigrationHistories: [],
    pageLoading: false,
  ...
  componentWillMount = () => {
    ...
    const resource = "userEmailDomainMigrationHistories";
    ...
    .then((response) => {
      ...
      const userEmailDomainMigrationHistories = halfred.parse(
          data).embeddedArray(
          "userEmailDomainMigrationHistories");

      this.setState({
        pageLoading: false,
        userEmailDomainMigrationHistories: userEmailDomainMigrationHistories
      });
    })
    .catch((error) => {
  ...
  render = () => {
    ...
    const {userEmailDomainMigrationHistories, alertMessage, pageLoading} = this.state;
        ...
        <Fragment>
          ...
          <main className={classes.layout}>
            <Paper classes={classes.paper}>
              {userEmailDomainMigrationHistories.map((row) => {
...
export default withRouter(withStyles(styles)(UserEmailDomainMigrationHistory));
