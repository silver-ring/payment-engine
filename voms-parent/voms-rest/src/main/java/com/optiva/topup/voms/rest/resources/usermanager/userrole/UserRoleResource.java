package com.optiva.topup.voms.rest.resources.usermanager.userrole;

import com.optiva.topup.voms.common.entities.usermanager.QUserRole;
...
public interface UserRoleResource extends JpaRepository<UserRole, Integer>,
    QuerydslPredicateExecutor<UserRole>, QuerydslBinderCustomizer<QUserRole> {
